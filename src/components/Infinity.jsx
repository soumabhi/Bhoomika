  ...
  return (
    <div className="bg-cyan-900 py-3 sm:py-4">
      <Marquee speed={50} gradient={false} className="text-white font-semibold text-base sm:text-lg md:text-xl capitalize">
        ...
        Book your eye checkup today and see the world more clearly! 📅 &nbsp;
        🌟 Clear vision, clear mind—protect your eyesight with us! 🏥 &nbsp; 💖
        Love your eyes, they show you the beauty of life. 🌎 &nbsp;
      </Marquee>
    </div>
  );
};
