        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-6">
            ...
            <p className="text-md text-center text-gray-700 md:text-left font-medium md:max-w-2/3">
              Pramod Heights, Near Kesura Chowk, Puri Bypass Road, Bhubaneswar - 752101
            </p>
            <div className="flex gap-6 text-gray-700">
              <a href="#" className="transition-transform transform hover:scale-110 hover:text-green-500 bg-gray-200 p-2 rounded-lg">
                <FaFacebookF size={24} />
              </a>
              <a href="#" className="transition-transform transform hover:scale-110 hover:text-green-500 bg-gray-200 p-2 rounded-lg">
                <FaInstagram size={24} />
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="flex flex-col gap-4 text-gray-700">
              <h2 className="text-2xl font-arial text-green-500 text-center md:text-left">Departments</h2>
            ...
            <div className="flex flex-col gap-4 text-gray-700">
              <h2 className="text-2xl font-arial text-green-500 text-center md:text-left">Get In Touch</h2>
              <ul className="space-y-2 md:space-y-3 text-md lg:text-lg tracking-wide font-medium text-gray-600 text-center md:text-start">
                <li>Support Available 24/7</li>
                <li>
                  <a href="mailto:info@bhoomikaeyeinstitute.com" className="hover:text-green-500">
                    info@bhoomikaeyeinstitute.com
                  </a>
                </li>
                <li className="flex items-center gap-2 text-gray-700">
                  <FaPhoneAlt size={18} className="text-green-500" />
                  <span>Mon to Fri: 08:30 am - 06:00 pm</span>
                </li>
                <li>9777050048</li>
              </ul>
            </div>
      ...
      <div className="bg-gray-900 py-4">
        <div className="container mx-auto text-center">
          <p className="text-sm md:text-base text-gray-300 font-medium">
            © Copyright Reserved to <span className="text-green-500">Bhoomika Eye Institute</span>
          </p>
        </div>
      </div>
    </>
